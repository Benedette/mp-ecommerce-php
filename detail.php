    ...
    <body>
        ...
        <script>
            ...
            function createOrder() {
                var ordersUrl = "https://benedette-mp-commerce-php.herokuapp.com/api/orders.php";
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var poll_url = "https://benedette-mp-commerce-php.herokuapp.com/api/status.php?external_reference="+external_reference;
            ...
            function cancelOrder() {
                clearInterval(pollInterval);
                var ordersUrl = "https://benedette-mp-commerce-php.herokuapp.com/api/delete-order.php";
